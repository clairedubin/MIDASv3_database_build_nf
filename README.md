...
6. Test nextflow installation. ```nextflow run main.nf -c nextflow.config -params-file params.json --genomes_tsv_path testing/inputs/genomes.tsv --db_output_dir testing -w testing/work```
7.  
