...
def build_markerdb(args):
    ...
    midas_db = MIDAS_DB(os.path.abspath(args.midasdb_dir), args.midasdb_name, num_cores=1)
    ...
    print(list_of_repgenome_marker_seqs)
    ...
    print()
    print(split(list_of_repgenome_marker_seqs.values(), 20))
    for _ in split(list_of_repgenome_marker_seqs.values(), 20):
        cmd = "cat " + " ".join(_) + f" >> {phyeco_seqs}"
        print(cmd)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--midasdb_name',
                           dest='midasdb_name',
                           type=str,
                           default="uhgg",
                           choices=MIDASDB_NAMES,
                           help="MIDAS Database name.")
    parser.add_argument('--midasdb_dir',
                           dest='midasdb_dir',
                           type=str,
                           default=".",
                           help="Path to local MIDAS Database.")
